...
public class EspecialidadesForm extends javax.swing.JInternalFrame {
    ...
    public void llenarTabla() {
        ...
        List<Especialidad> result = query.getResultList();
        DefaultTableModel model = (DefaultTableModel) table.getModel();
        model.setRowCount(0);
        for (Especialidad especialidadDb : result) {
            model.addRow(new Object[]{especialidadDb.getId(), especialidadDb.getNombre()});
        }
    ...
    private void saveButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveButtonMouseClicked
        ...
        if (campoNombre.getText().trim().isEmpty()) {
            ...
            Especialidad especialidadExistente = entityManager.find(Especialidad.class, nombre);
            if (especialidadExistente != null) {
                JOptionPane.showMessageDialog(null, " La especialidad," + nombre + " ya está en uso.", "Advertencia", JOptionPane.WARNING_MESSAGE);
            } else {
                Especialidad especialidadDb = new Especialidad(nombre);
                entityManager.getTransaction().begin();
                entityManager.persist(especialidadDb);
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        if (evt.getButton() == 1) {
            ...
            // Busqueda por id
            Especialidad especialidadDb = entityManager.find(Especialidad.class, table.getValueAt(row, 0));

            campoId.setEnabled(false);
            saveButton.setEnabled(false);
            campoId.setText(String.valueOf(especialidadDb.getId()));
            campoNombre.setText(especialidadDb.getNombre());
    ...
    private void modifyButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_modifyButtonMouseClicked
        ...
        Especialidad especialidadDb = entityManager.find(Especialidad.class, id);
        entityManager.getTransaction().begin();
        especialidadDb.setId(id);
    ...
    private void deleteButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteButtonMouseClicked
        ...
        Especialidad especialidadDb = entityManager.find(Especialidad.class, id);
        entityManager.getTransaction().begin();
        entityManager.remove(especialidadDb);
        entityManager.getTransaction().commit();
